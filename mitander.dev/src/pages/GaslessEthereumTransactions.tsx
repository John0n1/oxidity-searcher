    ...
    <div className="bg-page min-h-screen py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <p className="text-sm font-semibold text-emerald-700">Gasless Ethereum Transactions</p>
          <h1 className="mt-3 text-4xl font-semibold tracking-tight text-zinc-900 sm:text-5xl">
            Gasless Ethereum UX with disciplined economics and accountable settlement
          </h1>
          <p className="mt-6 text-lg leading-8 text-zinc-600">
            Mitander does not promise universal gasless execution. Instead, it applies deterministic policy to cover or refund gas
        ...
        <section className="mt-12 rounded-2xl border border-zinc-200 bg-zinc-900 p-8 text-white">
          <h2 className="text-2xl font-semibold">Ship a gasless UX that users actually trust</h2>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-300">
            Use private execution plus conditional gas coverage to offer lower-friction transactions, while preserving transparent value split and policy boundaries.
          </p>
