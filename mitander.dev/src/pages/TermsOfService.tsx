        ...
        <div className="space-y-8">
          <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-zinc-600">
              Mitander provides private Ethereum transaction routing, policy-based gas coverage decisions, and execution settlement reporting. Services may include
              public endpoints and partner-only access tiers with additional capabilities.
            </p>
          </section>
          ...
          <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <ul className="mt-4 list-disc pl-5 space-y-2 text-sm leading-7 text-zinc-600">
              ...
              <li>Use API keys and partner tokens only for the account they were issued to.</li>
            </ul>
          </section>
          ...
          <section className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
            <h2 className="text-xl font-semibold text-zinc-900 flex items-center gap-2">
              ...
              3. Policy-Based Gas Coverage
            </h2>
            <p className="mt-3 text-sm leading-7 text-zinc-600">
              Gas coverage is conditional. Eligibility is determined by live simulation, risk controls, and operating caps. A request can be routed privately without
              being eligible for gas coverage.
            </p>
            <p className="mt-3 text-sm leading-7 text-zinc-600">
              Mitander may change policy thresholds, safety controls, and spend limits to maintain system integrity.
            </p>
          </section>
