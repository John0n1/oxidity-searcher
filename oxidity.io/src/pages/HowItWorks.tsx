...
const steps = [
  {
    ...
    description: 'A partner integration sends a signed Ethereum transaction to Oxidity’s protected RPC instead of broadcasting it directly into public mempool gossip.',
    icon: ArrowRight,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    details: [
      ...
      { name: 'Private only', desc: 'No sponsorship, but still private routing and possible rebate.' },
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-zinc-600">
            A transparent pipeline from protected ingress to policy decisions, private submission, and settlement reporting.
          </p>
        </div>
