...
const risks = [
  ...
  },
  {
    ...
    description:
      'Opaque value capture harms trust. Settlement fields make sponsorship, retained share, and rebates auditable per transaction.',
    icon: ShieldAlert,
  },
];
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-zinc-600">
            Oxidity focuses on reducing common MEV loss surfaces by routing transactions privately, simulating outcomes before submission,
        ...
        <section className="mt-12 rounded-2xl border border-zinc-200 bg-white p-8">
          <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">Oxidity MEV mitigation model</h2>
        ...
        <section className="mt-12 rounded-2xl border border-zinc-200 bg-zinc-900 p-8 text-white">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-300">
            Teams integrating private execution can improve execution hygiene while keeping deterministic policy, commercial clarity, and transparent settlement behavior.
          </p>
